...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="secao">
            ...
            <h1 style="font-size: 250%; text-align: center; margin-top: 2%;">Informações do Funcionário</h1>
        ...
        <div class="flex-shrink-0 p-3" style="width: 280px; float: left;">
            ...
            <li class="mb-1">
                <button style="background-color: #F0D53B;" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                    Funcionário
                </button>
                <div>
