...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="secao">
            ...
            <h1 style="font-size: 250%; text-align: center; margin-top: 2%;">Adicionar Funcionário</h1>
        ...
        <div class="flex-shrink-0 p-3" style="width: 280px; float: left;">
            ...
            <li class="mb-1">
                <a href="funcionario"><button style="background-color: #F0D53B; border-style: none;" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                    Funcionário
                </button></a>
                <div>
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="funcionarioEditar" class="link-body-emphasis d-inline-flex text-decoration-none rounded"><button style="background-color: #E9DB8C; border-style: none;">Editar</button></a></li>
                    <li><a href="#" class="link-body-emphasis d-inline-flex text-decoration-none rounded"><button style="background-color: #F0D53B; border-style: none;">Adicionar</button></a></li>
                </ul>
                </div>
            </li>
            <li class="mb-1">
